...
## 5. Run the program
  To run the code i recommend to use the setup_ file you used before since it will check and do all the setups automaticly.
  ```terminal
  ./setup_windows.bat # Use the one for your operating system
  ```
